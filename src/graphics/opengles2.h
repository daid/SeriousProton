#ifndef SP_GRAPHICS_OPENGLES2_H
#define SP_GRAPHICS_OPENGLES2_H
...
extern void (GL_APIENTRY * glBlendColor)(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
...
extern void (GL_APIENTRY * glBlendFuncSeparate)(GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
extern void (GL_APIENTRY * glBufferData)(GLenum target, GLsizeiptr size, const GLvoid* data, GLenum usage);
extern void (GL_APIENTRY * glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid* data);
extern GLenum (GL_APIENTRY * glCheckFramebufferStatus)(GLenum target);
extern void (GL_APIENTRY * glClear)(GLbitfield mask);
extern void (GL_APIENTRY * glClearColor)(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
extern void (GL_APIENTRY * glClearDepthf)(GLclampf depth);
...
extern void (GL_APIENTRY * glCompressedTexImage2D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid* data);
extern void (GL_APIENTRY * glCompressedTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid* data);
...
extern void (GL_APIENTRY * glDepthRangef)(GLclampf zNear, GLclampf zFar);
...
extern void (GL_APIENTRY * glDrawElements)(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices);
...
extern void (GL_APIENTRY * glGetBooleanv)(GLenum pname, GLboolean* params);
...
extern void (GL_APIENTRY * glGetFloatv)(GLenum pname, GLfloat* params);
extern void (GL_APIENTRY * glGetFramebufferAttachmentParameteriv)(GLenum target, GLenum attachment, GLenum pname, GLint* params);
extern void (GL_APIENTRY * glGetIntegerv)(GLenum pname, GLint* params);
...
extern void (GL_APIENTRY * glGetVertexAttribPointerv)(GLuint index, GLenum pname, GLvoid** pointer);
...
extern void (GL_APIENTRY * glReadPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid* pixels);
...
extern void (GL_APIENTRY * glSampleCoverage)(GLclampf value, GLboolean invert);
extern void (GL_APIENTRY * glScissor)(GLint x, GLint y, GLsizei width, GLsizei height);
extern void (GL_APIENTRY * glShaderBinary)(GLsizei n, const GLuint* shaders, GLenum binaryformat, const GLvoid* binary, GLsizei length);
...
extern void (GL_APIENTRY * glStencilOpSeparate)(GLenum face, GLenum fail, GLenum zfail, GLenum zpass);
extern void (GL_APIENTRY * glTexImage2D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid* pixels);
...
extern void (GL_APIENTRY * glTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* pixels);
extern void (GL_APIENTRY * glUniform1f)(GLint location, GLfloat x);
extern void (GL_APIENTRY * glUniform1fv)(GLint location, GLsizei count, const GLfloat* v);
extern void (GL_APIENTRY * glUniform1i)(GLint location, GLint x);
extern void (GL_APIENTRY * glUniform1iv)(GLint location, GLsizei count, const GLint* v);
extern void (GL_APIENTRY * glUniform2f)(GLint location, GLfloat x, GLfloat y);
extern void (GL_APIENTRY * glUniform2fv)(GLint location, GLsizei count, const GLfloat* v);
extern void (GL_APIENTRY * glUniform2i)(GLint location, GLint x, GLint y);
extern void (GL_APIENTRY * glUniform2iv)(GLint location, GLsizei count, const GLint* v);
extern void (GL_APIENTRY * glUniform3f)(GLint location, GLfloat x, GLfloat y, GLfloat z);
extern void (GL_APIENTRY * glUniform3fv)(GLint location, GLsizei count, const GLfloat* v);
extern void (GL_APIENTRY * glUniform3i)(GLint location, GLint x, GLint y, GLint z);
extern void (GL_APIENTRY * glUniform3iv)(GLint location, GLsizei count, const GLint* v);
extern void (GL_APIENTRY * glUniform4f)(GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
extern void (GL_APIENTRY * glUniform4fv)(GLint location, GLsizei count, const GLfloat* v);
extern void (GL_APIENTRY * glUniform4i)(GLint location, GLint x, GLint y, GLint z, GLint w);
extern void (GL_APIENTRY * glUniform4iv)(GLint location, GLsizei count, const GLint* v);
...
extern void (GL_APIENTRY * glVertexAttrib1f)(GLuint indx, GLfloat x);
extern void (GL_APIENTRY * glVertexAttrib1fv)(GLuint indx, const GLfloat* values);
extern void (GL_APIENTRY * glVertexAttrib2f)(GLuint indx, GLfloat x, GLfloat y);
extern void (GL_APIENTRY * glVertexAttrib2fv)(GLuint indx, const GLfloat* values);
extern void (GL_APIENTRY * glVertexAttrib3f)(GLuint indx, GLfloat x, GLfloat y, GLfloat z);
extern void (GL_APIENTRY * glVertexAttrib3fv)(GLuint indx, const GLfloat* values);
extern void (GL_APIENTRY * glVertexAttrib4f)(GLuint indx, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
extern void (GL_APIENTRY * glVertexAttrib4fv)(GLuint indx, const GLfloat* values);
extern void (GL_APIENTRY * glVertexAttribPointer)(GLuint indx, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* ptr);
