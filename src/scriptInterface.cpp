...
{
    auto rMin = static_cast<float>(luaL_checknumber(L, 1));
    auto rMax = static_cast<float>(luaL_checknumber(L, 2));
...
{
    auto rMin = static_cast<int32_t>(luaL_checkinteger(L, 1));
    auto rMax = static_cast<int32_t>(luaL_checkinteger(L, 2));
    rMin = std::min(rMin, rMax);
